...
from lib.utils import load_prompt_template, screenshot_relative_path, read_visual_verdict
...
class TestLoadPromptTemplate:
    ...
    def test_substitutes_multiple_placeholders(self, tmp_path):
        ...
        result = load_prompt_template(tmp_path, "prompt.md", TITLE="Fix bug", BODY="Details here")
...
class TestReadVisualVerdict:
    ...
    def test_returns_content_when_file_exists(self, tmp_path):
        (tmp_path / "visual_verdict.txt").write_text("VISUAL: OK\nSELECTED: after_01.png", encoding="utf-8")
